...
# with table
#50-21.5 = 28.5
#check the table, where is 0.2852 ? z=0.79
#z = -0.79
...
while (TRUE) {
  ...
  if(Awins==5|Bwins==5) break
}

if(Awins==5) print("A win") else print("B win")

# Five wins (method 2: condition)
Awins <- 0
Bwins <- 0
while (Awins<5&Bwins<5) {
  A <- sample(c("rock", "paper", "scissors"),1)
  B <- sample(c("rock", "paper", "scissors"),1)
